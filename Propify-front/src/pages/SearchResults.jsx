  ...
  useEffect(() => {
    const fetchAndFilter = async () => {
      try {
        ...
        const results = data.filter((prop) => {
          const cityNormalized = normalize(prop.city);
          const provinceNormalized = normalize(prop.province);

          const isProvinceMatch = provinceNormalized === destino;
          const isCityMatch = cityNormalized === destino;

          const locationMatch = isCityMatch || (isProvinceMatch && !isCityMatch);
